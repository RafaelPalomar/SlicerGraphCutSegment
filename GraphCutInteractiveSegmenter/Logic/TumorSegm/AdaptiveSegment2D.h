...
private:
  ...
  std::vector<MyBasic::Index2D> fgseeds;
  std::vector<MyBasic::Index2D> bkseeds;
  std::vector<MyBasic::Index2D> starcenter;
  ...
  std::pair<Data2D<double>, Data2D<double> > smoothCostR;
  std::pair<Data2D<double>, Data2D<double> > smoothCostC;
  //store the smooth cost with lambda = 1
  std::pair<Data2D<double>, Data2D<double> > tmpSmoothCostR;
  std::pair<Data2D<double>, Data2D<double> > tmpSmoothCostC;
