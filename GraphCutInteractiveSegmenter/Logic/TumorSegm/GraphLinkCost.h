...
struct SparseTLink
{
  std::vector<double> fgcost;
  std::vector<double> bkcost;
  std::vector<int> id;
};
...
struct BidirectEdge
{
    ...
    BidirectEdge(void)
    {
        weight = std::vector<T>(2,T());
    }
    template<typename T2>
    BidirectEdge(const BidirectEdge<T2>& src)
    {
        weight = std::vector<T>(src.weight.begin(),src.weight.end());
    }
    ...
    {
        weight = std::vector<T>(weight)*scalar;
        return *this;
    }
    template<typename T2>
    operator T2()
...
struct SparseBidirectEdge
{
    ...
    {
        point2 = std::vector<MyBasic::Index2D>(2);
        weight = std::vector<T>(2);
        point2[0] = p1;
        point2[1] = p2;
        weight[0] = _w12;
        weight[1] = _w21;
    ...
    {
        point3 = std::vector<MyBasic::Index3D>(2);
        weight = std::vector<T>(2);
        point3[0] = p1;
        point3[1] = p2;
        weight[0] = _w12;
    ...
    std::vector<MyBasic::Index2D> point2;
    std::vector<MyBasic::Index3D> point3;
